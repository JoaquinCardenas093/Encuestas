...
def test_slide_shell_with_chart():
    chart = Chart(id="c1", question_id="q1", breakdown_ids=["sexo"], chart_type="PIE")
...
def test_chart_colors_defaults_to_empty_list():
    c = Chart(id="c1", question_id="q1", breakdown_ids=[], chart_type="PIE")
    assert c.colors == []


def test_chart_colors_accepts_hex_list():
    c = Chart(id="c1", question_id="q1", breakdown_ids=[], chart_type="PIE", colors=["#7F7F7F", "#BFBFBF"])
